...
**阶段 1 与阶段 2 转换 (Phase Transition between Stage 1 & 2)**
...
**全流程演示 (Full Task: From Unfolding to Placement)**
...
**通用性测试：刚性物体抓取 (Generalization: Rigid Object Grasping)**
...
**数据采集过程 (Data Collection & Training)**
